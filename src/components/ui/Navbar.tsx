    ...
    <nav className="fixed top-0 left-0 w-full px-6 md:px-16 py-10 flex justify-between items-start z-50">
      ...
      <div className="flex-none">
        <div className="flex flex-row gap-x-8 md:gap-x-12 font-medium tracking-tight text-lg md:text-xl">
          <a href="#projects" className="hover:text-[#a66ae6] transition-colors">
            projects
          </a>
          <a href="#about" className="hover:text-[#a66ae6] transition-colors">
            about me
          </a>
          <a href="#contacts" className="hover:text-[#a66ae6] transition-colors">
            contacts
          </a>
        </div>
      </div>
